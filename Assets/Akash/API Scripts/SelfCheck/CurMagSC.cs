...
public class CurMagSC : MonoBehaviour
{
    ...
    public void CurMagSelfCheck()
    {
        for (int i = 0; i < obsFibs.Length; i++)
        {
            if (obsFibs[0].text.ToLower().Replace(" ","") == "magneticfield" || obsFibs[0].text.ToLower().Replace(" ", "") == "magneticfields" )
            {
            ...
            if (obsFibs[1].text.ToLower().Replace(" ", "") == "larger")
            {
            ...
            if (obsFibs[3].text.ToLower().Replace(" ", "") == "numberofmagneticfieldlinespassingthroughaunitarea")
            {
