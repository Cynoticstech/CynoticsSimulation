...
public class PhotoelectricEffectSceneload : MonoBehaviour
{
    // Name of the scene to load
    private string PhotoelectricEffectSceneName = "PhotoelectricEffect";
    ...
    public void OnButtonClick()
    {
        ...
        SceneManager.LoadScene(PhotoelectricEffectSceneName);
    }
